...
const onTheme = () => emit("switchTheme");
</script>

<template>
  <div class="host">
    <a href="https://github.com/ycw/three-shaderlib-skim">
      <svg width="48px" height="48px" viewBox="0 0 48 48" id="octocat">
        <title>go to repo</title>
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
